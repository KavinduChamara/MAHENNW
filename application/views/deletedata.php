    ...
    <section id="content">
     ...
     <script>
                 function validateForm() {
                      var x = document.forms["deleteform"]["cnic"].value;
                          if (x == null || x == "") {
                 ...
                 function alphanumeric(inputtxt){   
                              ...
                              if(inputtxt.value.match(letters)){  
                                       alert('NIC have accepted : you can try another');  
                                       return true;  
                            }else{  
                                       alert('Please input alphanumerics only');  
                                       return false;  
                            }  
                    }                
        </script>
                ...
                <div class="container"   style="margin-left:-5%;">  
                          <form  action="datadeletebackend.php" method="post" name="deleteform" onsubmit = "return validateForm()">
                         ...
                         <input type="submit" name="deletebutton" value="DELETE DATA" onclick='letters(inputtxt1);' style = "width:505px;height:30px; margin-top:5px; background-color:#1475ff"/>
