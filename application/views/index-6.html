...
<!-- Mirrored from cdn.livedemo00.template-help.com:82/wt_40305/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Nov 2016 11:52:28 GMT -->
<head>
  	<title>Mail</title>
  	<meta charset="utf-8">
...
<!--==============================header=================================-->
    	...
    	<div class="main">        	
            <nav>
                <ul class="sf-menu">
                    ...
                    <li class="active"><a href="index-6.html">mail</a></li>
                </ul>
            </nav>            
            <div class="clear"></div>            
        </div>
            ...
            <div class="container_24">
                	<article class="grid_15">
                        ...
                        <figure class="page6-img1 img-bot">
                            <iframe width="570" height="336" src="http://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=Brooklyn,+New+York,+NY,+United+States&amp;aq=0&amp;sll=37.0625,-95.677068&amp;sspn=61.282355,146.513672&amp;ie=UTF8&amp;hq=&amp;hnear=Brooklyn,+Kings,+New+York&amp;ll=40.649974,-73.950005&amp;spn=0.01628,0.025663&amp;z=14&amp;iwloc=A&amp;output=embed">
                            </iframe>
                        </figure>
                        <div class="clear"></div>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Praesent vestibulum molestie lacus. Aenean nonummy hendrerit mauris. Phasellus porta. Fusce suscipit varius mi. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a, lorem. Maecenas tristique orci ac sem. </p>
                         <dl class="dl1">
                            ...
                            <dd><span>Freephone:</span>   +1 800 603 6035</dd>                                    
                    ...
                    <h2>Feedback</h2>
                        ...
                        <div class="success">Contact form submitted!<strong> We will be in touch soon.</strong></div>
                          <fieldset>
                              ...
                              <div class="clear"></div>
                              <div class="link-form">     
                              <a class="button2 p27" href="#" data-type="reset">Reset</a>                          
                              <a class="button2" href="#" data-type="submit">Send message</a>                              
                              </div>											
                          </fieldset>           
                      </form>
                    </article>
    ...
    <footer>
        ...
        <div class="foot-page1">
        	<span>digital print</span>&copy; 2012&nbsp; |&nbsp;  <a href="index-7.html">Privacy Policy</a>
            <div class="clear"></div>
        </div>
        <ul class="foot-menu">
                    ...
                    <li><a href="index-4.html">services</a></li>
                    <li><a href="index-5.html">Creations</a></li>
                    <li class="last1"><a class="active" href="index-6.html">contacts</a></li>
                </ul>
        <div class="clear"></div>        
        </div>
    </footer>
