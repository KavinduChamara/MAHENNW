    ...
    <section id="content">
        <div class="main">
            <div class="container_24">
                    ...
                    <article class="grid_8 push_1" style = "margin-left:270px;">
                    <h2 >Update Payments</h2>

      <script>
                 function validateForm() {
                      var x = document.forms["updateform"]["cname"].value;
                          if (x == null || x == "") {
                             alert("Name must be filled out");
                             return false;
                      }
                     
                      var x = document.forms["updateform"]["cnic"].value;
                          if (x == null || x == "") {
                             alert("NIC must be filled out");
                             return false;
                      }
                      
                      var x = document.forms["updateform"]["pammount"].value;
                          if (x == null || x == "") {
                             alert("Ammount must be filled out");
                             return false;
                      }
                      
                      var x = document.forms["updateform"]["recno"].value;
                          if (x == null || x == "") {
                      ...
                      var x = document.forms["updateform"]["ctelno"].value;
                          if (x == null || x == "") {
                   ...
                   <div class="container"   style="margin-left:-5%;">  
                          <form  action="dataupdatebackend.php" method="post" name="updateform" onsubmit = "return validateForm()">
                       ...
                       <fieldset>
                         ...
                         <input type="submit" name="updatebutton" value="UPDATE DATA" onclick='letters(inputtxt1);' style = "width:505px;height:30px; margin-top:5px; background-color:#1475ff"/>
