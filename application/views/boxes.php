                              ...
                              <ul>
                                <li>
                                    <article class="grid_6">
                                        ...
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img1.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img2.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img3.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img4.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img5.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img6.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img7.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img8.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img9.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img10.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img11.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img12.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img13.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img14.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
                                <li>
                                    <article class="grid_6">
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img15.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                        <div class="page5-box1">
                                        <figure class="page5-img1 img-bot"><img src="<?php echo base_url('public/images/boxes/img16.jpg'); ?>" alt=""></figure>
                                        <div class="clear"></div>
                                        </div>
                                    </article>
                                </li>
